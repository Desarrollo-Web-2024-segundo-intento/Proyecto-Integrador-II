  ...
  async fetchData() {
    try {
      ...
      console.log('Datos recibidos:', data);
        ...
        newDiv.style.backgroundImage = 'url("assets/img/clinico.png")'; // Cambia esta ruta a la de tu imagen
        ...
        div_contenedor.style.backgroundColor = 'transparent';
        ...
        div_titulo.style.backgroundColor = 'transparent'; 
        ...
        // // div_boton_turno.style.backgroundColor = 'transparent';
        ...
        const boton_turno = document.createElement('button');
        boton_turno.innerText = 'Agendar Turno';
        boton_turno.style.width = '90%';
        boton_turno.style.height = '50px';
        boton_turno.style.font='12px';
        boton_turno.style.backgroundColor = 'transparent';
        boton_turno.style.display = 'flex';
        boton_turno.style.flexDirection = 'column';
        boton_turno.style.justifyContent = 'center';
        boton_turno.style.alignItems = 'center';
        boton_turno.style.border = '2px solid black';
        //titulo.style.float = 'left';
        boton_turno.style.margin = '10px';
        boton_turno.addEventListener('click', () => {
          this.router.navigateByUrl(['/turnos']);
        });
        div_boton_turno.appendChild(boton_turno);
